...
class DecouvrirPage extends StatefulWidget {
  const DecouvrirPage({Key key}) : super(key: key);
...
class _DecouvrirPageState extends State<DecouvrirPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider<MovieBlocDecouvrir>(
          create: (_) => MovieBlocDecouvrir()..add(MovieEventStarted(0, '')),
        ),
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        return SingleChildScrollView(
          child: ConstrainedBox(
            ...
            child: BlocBuilder<MovieBlocDecouvrir, MovieState>(
